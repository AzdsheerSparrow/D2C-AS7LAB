...
def dcc_main(
    ...
    dex2c_file_data = dex2c_file_data.replace(
        'env->FindClass("Azdsheer/Sparrow/AS7LAB");',
        'env->FindClass("' + custom_loader.replace(".", "/") + '");',
    )
    dex2c_file_data = dex2c_file_data.replace(
        "Java_Azdsheer_Sparrow_AS7LAB", "Java_" + custom_loader.replace(".", "_")
    )
    ...
    if is_apk(apkfile) and outapk:
        ...
        loader_file_path = "loader/AS7LAB.smali"
        ...
        filedata = filedata.replace(
            "LAzdsheer/Sparrow/AS7LAB;", "L" + custom_loader.replace(".", "/") + ";"
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--custom-loader",
        default="Azdsheer.Sparrow.AS7LAB",
        help="Loader class, default: Azdsheer.Sparrow.AS7LAB",
    )
    parser.add_argument(
        "--skip-synthetic",
        action="store_true",
