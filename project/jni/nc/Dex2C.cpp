...
Java_Azdsheer_Sparrow_AS7LAB_initDcc__(JNIEnv *env, jobject thiz) {

}

JNIEXPORT void JNICALL
Java_Azdsheer_Sparrow_AS7LAB__0003cinit_0003e__(JNIEnv *env, jobject thiz) {
...
JNIEXPORT jint JNI_OnLoad(JavaVM *vm, void *reserved) {
    ...
    jclass clz = env->FindClass("Azdsheer/Sparrow/AS7LAB");
